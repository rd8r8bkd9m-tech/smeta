...
export class CalculationEngine {
   ...
   */
  calculateMaterialWithWaste(quantity: number, wasteCoefficient: number = 1.05): number {
   ...
   */
  calculateLaborHours(quantity: number, normHours: number, difficultyCoef: number = 1.0): number {
   ...
   */
  applyPriceIndex(basePrice: number, baseYear: number, targetYear: number): number {
